...
Mapbox.setAccessToken(
  'sk.eyJ1IjoiN3huM3VtbHQiLCJhIjoiY205M3Y3bzZuMG11NzJqcXozOTQ5YjB0YSJ9.fk8RU7RNlM0QDj9WUw-84A',
);
...
const MapboxTest = ({navigation}) => {
      ...
      case 'polygon':
        geometry = {
          ...
          coordinates:
            drawingMode === 'polyline'
              ? drawingPoints
              : [drawingPoints.concat(drawingPoints[0])],
        };
        break;
      default:
        return;
  ...
  return (
    <View style={styles.container}>
      ...
      }} style={{paddingTop: 10,paddingBottom:10, backgroundColor: '#fff',display:"flex",flexDirection:"row",alignItems:"center",paddingLeft:20}}>
        <Icon name="search" size={24} color={Colors.black} />
        <Text>搜索林班</Text>
      </TouchableOpacity>
      <Mapbox.MapView ref={mapRef} style={styles.map} onPress={handleMapPress}>
        <Mapbox.Camera
          zoomLevel={14}
      ...
      {showCommandCenter && <CommandCenter onClose={handleClosePanel} />}
